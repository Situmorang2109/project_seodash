...
Route::prefix('user')->middleware(['auth', UserMiddleware::class])->group(function () {
    ...
    Route::get('/profile/create', [UserDashboardController::class, 'profileCreate'])->name('user.profile.create'); // optional
    Route::get('/profile/edit', [UserDashboardController::class, 'profileEdit'])->name('user.profile.edit'); // optional
